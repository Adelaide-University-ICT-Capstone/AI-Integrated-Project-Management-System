...
**Repository & CI Setup**
- Created the initial repository and bootstrapped the project
- Connected the GitHub Actions CI workflow to Jira (SCRUM-27) for sprint tracking
- Initialised project collaboration templates (PR templates, planning docs)

**Frontend**
- Redesigned the admin dashboard — overhauled the Projects and People admin views layout
- Wired the People page to the live `/employees/` and `/customers/` APIs
- Fixed workforce allocation UI persistence (assignments were not saved on page reload)
- Removed hardcoded workforce names; all names now fetched from the API
- Built the admin settings preference displays and documented API gaps as notes
- Wired the People page role selector to the `/roles/` API
- Refined dashboard and admin navigation flows
...
|------------------|----------|-------|------|-----|
| Initial repo + CI | ✅ FastAPI scaffold | ✅ Repo init, Jira CI | — | — |
...
| Analytics API | — | — | — | ✅ |
| Deployment / Docker | ✅ | — | — | — |
| Admin / Auth frontend | ✅ | ✅ UI redesign | — | — |
| People / Roles frontend | — | ✅ | — | — |
| Workforce UI | ✅ Wiring | — | — | ✅ UI |
| Analytics frontend | — | — | — | ✅ |
