    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-3">
          ...
          {editingWorkflow && (
            <button
              onClick={(e) => {
                ...
                // and re-select the phase we're trying to delete.
                e.stopPropagation()
                onRemove()
              }}
          ...
          {/* Rotate the chevron 90° when this phase is selected
              so it feels like an accordion. */}
          <ChevronRight
            size={18}
      ...
      {/* Progress slider — clicking it shouldn't trigger the row's onClick */}
